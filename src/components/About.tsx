...
function Counter({ value, suffix = "" }: { value: number; suffix?: string }) {
  ...
  return (
    <span
      ref={ref}
      className="font-bold text-3xl sm:text-4xl md:text-5xl bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent"
    >
      {count}
      {suffix}
    </span>
  ...
  const highlights = [
    {
      ...
      description:
        "Building modular, highly performant web architectures using modern React JS.",
    },
    {
      icon: Smartphone,
      title: "Mobile App Development",
      description:
        "Creating smooth, native-feeling cross-platform mobile apps with React Native Expo.",
    },

    {
      ...
      description:
        "Integrating RESTful APIs to enable seamless data communication and dynamic application functionality.",
    },
  ];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            I am a Frontend Developer dedicated to creating visual, responsive,
            and performance-optimized user interfaces. By blending clean design
            aesthetics with scalable engineering practices, I build experiences
            that run smoothly on any screen.
          </motion.p>
        </div>

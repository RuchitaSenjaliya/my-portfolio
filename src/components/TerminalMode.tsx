      ...
      case 'help':
        output = (
          <div className="space-y-1">
            ...
            <p className="text-yellow-400">  clear     <span className="text-white/60">- Clear terminal logs</span></p>
            <p className="text-yellow-400">  exit      <span className="text-white/60">- Close terminal mode</span></p>
          </div>
        );
        break;
      ...
      case 'skills':
        output = (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-1">
            <div>
              <p className="text-primary font-semibold border-b border-white/10 pb-0.5">Frontend</p>
              <p className="text-white/80">React.js, Next.js, Angular, JavaScript, TypeScript, HTML, CSS, Tailwind, Material UI, Ionic</p>
            </div>
            <div>
              <p className="text-primary font-semibold border-b border-white/10 pb-0.5">Mobile & Tools</p>
              <p className="text-white/80">React Native, Expo, Redux, Context API, React Query, Git, GitHub, Postman, Figma, VS Code</p>
            </div>
          </div>
        );
        break;
      ...
      case 'projects':
        output = (
          <div className="space-y-2 mt-1">
            <div>
              <p className="text-yellow-400 font-bold">1. Employee Management System</p>
              <p className="text-white/75">  React + Redux + Material UI | Authentication and HR Admin Dashboard</p>
            </div>
            <div>
              <p className="text-yellow-400 font-bold">2. Hotel Management System</p>
              <p className="text-white/75">  Angular + Ionic | Room booking calendars & PDF billing reports</p>
            </div>
            <div>
              <p className="text-yellow-400 font-bold">3. Blog AI Generator</p>
              <p className="text-white/75">  Next.js + OpenAI API | AI post builder and metadata advisor</p>
            </div>
            <div>
              <p className="text-yellow-400 font-bold">4. AgroSmart</p>
              <p className="text-white/75">  React Native + Firebase | Direct WhatsApp chat & product tracking</p>
            </div>
          </div>
        );
        break;
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-slate-950 border-b border-slate-800 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/60 font-semibold">ruchita-portfolio-cli.sh</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="text-[10px] text-white/30 hidden sm:inline">Press Ctrl+` to toggle</span>
                <button 
            ...
            <form onSubmit={handleCommandSubmit} className="flex items-center gap-2 px-5 py-3.5 bg-slate-950 border-t border-slate-800 shrink-0">
              <span className="text-green-500 font-bold">guest@ruchita-dev:~$</span>
              <input
                ref={inputRef}
                type="text"
                value={input}
                ...
                autoCapitalize="off"
              />
              <button type="submit" className="text-white/40 hover:text-green-400 cursor-pointer">

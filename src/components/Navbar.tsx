        ...
        <div className="flex items-center gap-2 lg:hidden select-none">
          ...
          <div className="flex items-center bg-card-bg/60 border border-card-border p-0.5 rounded-full text-[10px]">
            <button
              ...
              className={`flex items-center gap-1 px-2.5 py-1 rounded-full font-bold transition-all cursor-pointer ${
                portfolioMode === 'code' ? 'bg-primary text-white' : 'text-foreground/60'
              }`}
            >
            ...
            <button
              onClick={() => setPortfolioMode('canvas')}
              className={`flex items-center gap-1 px-2.5 py-1 rounded-full font-bold transition-all cursor-pointer ${
                portfolioMode === 'canvas' ? 'bg-secondary text-white' : 'text-foreground/60'
              }`}
            >
          ...
          <button
            ...
            className={`flex items-center justify-center w-8 h-8 rounded-full border transition-colors ${
              isTerminalOpen ? 'bg-primary border-primary text-white' : 'bg-card-bg/50 border-card-border text-foreground/80'
            }`}
            aria-label="Terminal"
          >
          ...
          <button
            onClick={() => setIsAIAssistantOpen(!isAIAssistantOpen)}
            className={`flex items-center justify-center w-8 h-8 rounded-full border transition-colors ${
              isAIAssistantOpen ? 'bg-primary border-primary text-white' : 'bg-card-bg/50 border-card-border text-foreground/80'
            }`}
